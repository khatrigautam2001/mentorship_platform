...
import { DollarSign, Mail, Phone, User as UserIcon, Save } from "lucide-react";
...
interface MenteeProfile extends User {
  totalPaid: number;
  remaining: number;
}
...
export default function MenteeProfile() {
  ...
  const { data: profile, isLoading } = useQuery<MenteeProfile>({
  ...
  const updateProfileMutation = useMutation({
    mutationFn: (data: ProfileFormData) =>
      apiRequest("PATCH", "/api/mentee/profile", data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/mentee/profile"] });
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  <div>
                    ...
                    <p className="text-xl font-bold font-mono">
                      ₹{Number(profile.totalFee).toLocaleString()}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold font-mono" data-testid="text-remaining-payment">
                      ₹{profile.remaining.toLocaleString()}
                    </p>
                  </div>
                </div>
              </CardContent>
